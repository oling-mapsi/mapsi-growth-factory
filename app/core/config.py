...
class Settings(BaseSettings):
    ...
    editorial_article_min_chars: int = 280
    editorial_article_max_chars: int = 12000
    editorial_similarity_threshold: float = 0.78
    editorial_agent_input_cost_per_1m_tokens: float = 0.0
    editorial_agent_output_cost_per_1m_tokens: float = 0.0
    auto_publish_web_enabled: bool = False
    auto_publish_mapsi_market: bool = False
    auto_publish_oling_practice: bool = False
    auto_publish_min_quality_score: str = ""
    auto_publish_block_on_warning: bool = True
    auto_publish_delay_minutes: int = 0
    mapsi_market_schedule: str = ""
    oling_practice_schedule: str = ""
    editorial_timezone: str = "Europe/Paris"
    ...
    studio_admin_role_permissions: str = (
        ...
        "  ROLE_GROWTH_ADMIN: [GROWTH_VIEW, GROWTH_REVIEW, GROWTH_APPROVE, GROWTH_PUBLISH, GROWTH_CONFIGURE, GROWTH_AUDIT]\n"
        "  ROLE_MAPSI_MASTER: [GROWTH_VIEW, GROWTH_REVIEW, GROWTH_APPROVE, GROWTH_PUBLISH, GROWTH_CONFIGURE, GROWTH_AUDIT]\n"
    ...
    studio_admin_legacy_api_visible: bool = False
